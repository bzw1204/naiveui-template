      ...
      <n-flex vertical justify="space-evenly" class="box-border h-500 w-400 bg-white p-15">
        ...
        >
          ...
          <n-flex justify="space-between" class="mb-15">
            <n-checkbox v-model:checked-value="rememberMe">记住我</n-checkbox>
            <n-a>忘记密码？</n-a>
          </n-flex>
            ...
            <template #icon>
              <n-icon>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8zm-1-13h2v2h-2zm0 4h2v6h-2z" fill="currentColor"></path>
                </svg>
              </n-icon>
            </template>
            使用Google账号登录
